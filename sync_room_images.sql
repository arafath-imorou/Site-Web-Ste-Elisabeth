...
UPDATE rooms SET image = '/Images/chambre_harmonie.jpg' WHERE name = 'Harmonie' AND site = 'Abomey-Calavi';
...
-- Abomey-Calavi Sites
INSERT INTO room_images (room_id, url) SELECT id, '/Images/chambre_harmonie.jpg' FROM rooms WHERE name = 'Harmonie' AND site = 'Abomey-Calavi';
...
UPDATE gallery SET image_url = '/Images/chambre_harmonie.jpg' WHERE title = 'Chambre Harmonie';
